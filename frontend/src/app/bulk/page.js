...
export default function BulkRegistrationPage() {
  ...
  const handleAddMember = () => {
    ...
    const requiredFields = [
      ...
      'place_of_residence', 'hometown', 'relative_contact', 'membership_status'
    ];
    ...
    const missingFields = requiredFields.filter(field => !currentMember[field]);
  ...
  const handleSubmit = async () => {
    ...
    console.log('Submitting bulk members:', { congregation: selectedCongregation, members });
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white shadow rounded-lg p-6">
        ...
        <p className="text-gray-600 mt-2">Add multiple members to the system at once</p>
      </div>

      {/* Congregation Selection */}
      <div className="bg-white shadow rounded-lg p-6">
        <h3 className="text-lg font-medium text-gray-900 mb-4">Select Congregation</h3>
        <select
        ...
        >
          <option value="" className="text-gray-800">Choose Congregation</option>
      ...
      <div className="bg-white shadow rounded-lg p-6">
        ...
        <div className="mb-4 p-3 bg-blue-50 border border-blue-200 rounded-md">
          <p className="text-sm text-blue-700">
            <span className="font-medium">Note:</span> Fields marked with <span className="text-red-500 font-bold">*</span> are required and must be filled.
          </p>
        </div>
        
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">First Name <span className="text-red-500 font-bold">*</span></label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">Last Name <span className="text-red-500 font-bold">*</span></label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">Phone Number <span className="text-red-500 font-bold">*</span></label>
            <input
              type="tel"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">Gender <span className="text-red-500 font-bold">*</span></label>
            <select
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => setCurrentMember({...currentMember, date_of_birth: e.target.value})}
              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-800"
            />
          </div>
          
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">Place of Residence <span className="text-red-500 font-bold">*</span></label>
            <input
              type="text"
              value={currentMember.place_of_residence}
              onChange={(e) => setCurrentMember({...currentMember, place_of_residence: e.target.value})}
              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-800"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">Hometown <span className="text-red-500 font-bold">*</span></label>
            <input
              type="text"
              value={currentMember.hometown}
              onChange={(e) => setCurrentMember({...currentMember, hometown: e.target.value})}
              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-800"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">Relative Contact <span className="text-red-500 font-bold">*</span></label>
            <input
              type="text"
              value={currentMember.relative_contact}
              onChange={(e) => setCurrentMember({...currentMember, relative_contact: e.target.value})}
              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-800"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">Membership Status <span className="text-red-500 font-bold">*</span></label>
            <select
              value={currentMember.membership_status}
              onChange={(e) => setCurrentMember({...currentMember, membership_status: e.target.value})}
              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-800"
              required
            >
              <option value="Active" className="text-gray-800">Active</option>
              <option value="Distant" className="text-gray-800">Distant</option>
            </select>
          </div>
          ...
          <div className="flex items-center space-x-4">
            <label className="flex items-center">
              <input
                ...
                onChange={(e) => {
                  ...
                  setCurrentMember({
                    ...
                    executive_level: isExecutive ? currentMember.executive_level : '',
                    executive_position: isExecutive ? currentMember.executive_position : '',
             ...
             <>
               <div>
                 <label className="block text-sm font-medium text-gray-700 mb-2">Executive Level <span className="text-red-500 font-bold">*</span></label>
                 <select
                 ...
                 >
                   ...
                   <option value="branch" className="text-gray-800">Branch Only</option>
                   <option value="district" className="text-gray-800">District Only</option>
                   <option value="both" className="text-gray-800">Both Branch & District</option>
                 </select>
               </div>
               <div>
                 <label className="block text-sm font-medium text-gray-700 mb-2">Executive Position <span className="text-red-500 font-bold">*</span></label>
                 <select
                   ...
                   onChange={(e) => {
                     ...
                     setCurrentMember({
                       ...
                       position: selectedPosition ? getExecutivePositionDisplay(selectedPosition) : ''
                     });
                   }}
                   className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-800"
                   required
                 ...
                 >
                   ...
                   {currentMember.executive_level === 'branch' && (
                     <>
                       <option value="president" className="text-gray-800">President</option>
                       <option value="vice_president" className="text-gray-800">Vice President</option>
                       <option value="secretary" className="text-gray-800">Secretary</option>
                       <option value="assistant_secretary" className="text-gray-800">Assistant Secretary</option>
                       <option value="financial_secretary" className="text-gray-800">Financial Secretary</option>
                       <option value="treasurer" className="text-gray-800">Treasurer</option>
                       <option value="organizer" className="text-gray-800">Organizer</option>
                       <option value="evangelism_coordinator" className="text-gray-800">Evangelism Coordinator</option>
                     </>
                   )}
                   {currentMember.executive_level === 'district' && (
                     <>
                       <option value="president" className="text-gray-800">President</option>
                       <option value="presidents_rep" className="text-gray-800">President's Rep</option>
                       <option value="secretary" className="text-gray-800">Secretary</option>
                       <option value="assistant_secretary" className="text-gray-800">Assistant Secretary</option>
                       <option value="financial_secretary" className="text-gray-800">Financial Secretary</option>
                       <option value="treasurer" className="text-gray-800">Treasurer</option>
                  ...
                  <tr key={member.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                       ...
                       {member.is_executive ? (
                         <div>
                           <div className="font-medium text-gray-700">{member.executive_position}</div>
                           <div className="text-xs text-gray-600">
                             {member.executive_level === 'both' ? 'Branch & District' : 
                              member.executive_level === 'district' ? 'District' : 'Branch'}
                           </div>
                         </div>
                       ) : member.position}
                     </td>
