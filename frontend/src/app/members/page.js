...
export default function MembersPage() {
  ...
  // Function to generate congregation-specific mock data
  const generateCongregationSpecificMockData = (congregationName) => {
    ...
    // Add congregation-specific local executives and members
    if (congregationName && congregationName !== "District Admin") {
      // Local executives for the specific congregation
      const localExecutives = [
        {
          id: 9,
          first_name: "Maria",
          last_name: "Rodriguez",
      ...
      // Regular members for the specific congregation
      ...
      return [...baseMembers, ...localExecutives, ...regularMembers];
    }

    // For District Admin, return all data from multiple congregations
    return [
      ...baseMembers,
